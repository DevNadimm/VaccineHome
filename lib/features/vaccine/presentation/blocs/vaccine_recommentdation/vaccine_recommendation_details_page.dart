...
class VaccineRecommendationDetailsPage extends StatelessWidget {
  static Route route({required VaccineRecommendation recommendation}) => MaterialPageRoute(
        builder: (_) => BlocProvider(
          create: (_) => ImageSelectionCubit(),
          child: VaccineRecommendationDetailsPage(recommendation: recommendation),
        ),
      );
