...
class AboutUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String aboutUsDescription = "Welcome to Vaccine Sheba,\n\nAt Vaccine Sheba, we believe healthcare should be simple, accessible, and reliable. Our mission is to provide a trusted digital health companion that helps individuals and families stay on top of their vaccination schedules and overall well-being.\n\nWe know that keeping track of vaccines and health reminders can be challenging. That’s why we created a platform to manage everything in one place — from timely notifications to secure health records.\n\nOur team is dedicated to combining technology with healthcare innovation. We aim to deliver accurate information, personalized reminders, and easy-to-use features that fit into your daily routine.\n\nWith Vaccine Sheba, you are not just staying updated with vaccines — you are building a healthier and safer future for yourself and your loved ones.\n\nThank you for trusting Vaccine Sheba as your digital health companion.";
