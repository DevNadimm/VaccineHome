...
**Terms and Conditions for Vaccine Sheba**

Welcome to Vaccine Sheba! By using our app, you agree to the following terms and conditions:

**1. Use of App:**
- Vaccine Sheba is intended to provide vaccination reminders, health information, and management of personal health records.
...
- Vaccine Sheba provides reminders and information; it is not a substitute for professional medical advice.
- Always consult healthcare professionals for medical decisions.

**4. Intellectual Property:**
- All content, design, and branding of Vaccine Sheba are the property of the app developers.
- You may not reproduce, distribute, or modify any part of the app without permission.

**5. Third-Party Services:**
- Vaccine Sheba may integrate with third-party services (e.g., notifications, analytics).
- Use of these services is subject to their respective terms.

**6. Limitation of Liability:**
- Vaccine Sheba is not liable for any direct or indirect damages arising from the use of the app.
