...
class ConsultationCard extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(
                ...
                text: DateConversionHelper.toReadable(consultation.nextConsultationDate ?? ''),
              ),
              const SizedBox(height: 8),
              _buildInfoRow(
                icon: HugeIcons.strokeRoundedClock01,
                text: TimeConversionHelper.to12Hour(consultation.nextConsultationTime ?? ''),
              ),
              const SizedBox(height: 8),
              _buildInfoRow(
                icon: HugeIcons.strokeRoundedLocation01,
                text: consultation.address ?? 'No address provided',
              ),
              const SizedBox(height: 12),
              _buildActions(),
            ],
  ...
  Widget _buildHeader() {
    return Text(
      consultation.doctorName ?? 'Unnamed Doctor',
